...
export default class Reviews extends React.Component {
  ...
  getSummaryData() {
    ...
    request
      .get(`http://http://ec2-3-15-13-135.us-east-2.compute.amazonaws.com:3010/${restaurantId}/summary`)
      .then((res) => {
  ...
  getReviewsData() {
    const { restaurantId } = this.props;
    request
      .get(`http://http://ec2-3-15-13-135.us-east-2.compute.amazonaws.com:3010/${restaurantId}/reviews`)
      .then((res) => {
